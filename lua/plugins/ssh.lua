return {
  ...
  config = function()
    ...
    local ok, util_telescope = pcall(require, "lazyvim.util.telescope")
    if ok then
      telescope_find_files = util_telescope("files", {})
      telescope_live_grep = util_telescope("live_grep", {})
    else
      local Util = require("lazyvim.util")
      telescope_find_files = Util.pick("files", {})
      telescope_live_grep = Util.pick("live_grep", {})
    end
